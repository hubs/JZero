...
public class MEncrypt {
	...
	private static final String PASSWORD_CRYPT_KEY = "ICPassword";
	...
	public static void main(String[] args) {
		String n1=encrypt("root");
		String n2=encrypt("guilinsoft");
		MPrint.print(n1+","+n2);
		MPrint.print(decrypt(null));
		MPrint.print(decrypt(n2));
	}
}
